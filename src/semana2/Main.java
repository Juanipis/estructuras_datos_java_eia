...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*Establecemos d�as de los trabajadores*/
		///*
		...
		pr1.setCantDiasTrabajados("Ma�i�o", 14);
		...
		System.out.println("Trabajador que tiene el salario m�s peque�o: " + pr1.getSalarioMinTrabajador());
